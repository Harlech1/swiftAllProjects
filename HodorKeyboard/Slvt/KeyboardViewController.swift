...
class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLoad() {
        ...
        hodorButton.frame = CGRect(x: 100, y: 50, width: 140, height: 60)
        hodorButton.setBackgroundImage(UIImage(named: "slvt.png"), for: UIControl.State.normal )
